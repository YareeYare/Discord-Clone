	...
	return (
		<>
			<button
				...
				<kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 font-medium
					rounded border bg-muted px-1.5 font-mono text-[10px] text-muted-foreground ml-auto">
